...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [_NUMBER] = LAYOUT_split_3x6_3_ex2(
        //,-----------------------------------------------------. --------  -------- ,-----------------------------------------------------.
             SW_WIN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  LOGOUT, XXXXXXX,   XXXXXXX,  KC_LBRC,    KC_7,    KC_8,    KC_9, KC_RBRC, _______,
        //|--------+--------+--------+--------+--------+--------| --------  -------- |--------+--------+--------+--------+--------+--------|
             SW_APP, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, XXXXXXX, _______,   _______,  KC_SCLN,    KC_4,    KC_5,    KC_6,  KC_EQL, _______,
        //|--------+--------+--------+--------+--------+--------| --------  -------- |--------+--------+--------+--------+--------+--------|
            _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_TILD,    KC_1,    KC_2,    KC_3, KC_BSLS, _______,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                                _______, _______, _______,      KC_P0, KC_MINS,  KC_DOT
        //                                    `--------------------------'  `--------------------------'
    ),
